...
class SendWhatsAppMessage : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sendMessage.setOnClickListener {
            ...
            if (installed && !checkInputs) {
                ...
                Toast.makeText(this@SendWhatsAppMessage, "Whatsapp May Be not installed! Or Error in Inputs", Toast.LENGTH_SHORT)
                    .show()
            }
        }
